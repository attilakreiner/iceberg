...
public abstract class TestWriterMetrics<T> {
  ...
  public void verifySortedColMetric() throws Exception {
    ...
    assertThat((int) Conversions.fromByteBuffer(Types.IntegerType.get(), lowerBounds.get(1)))
        .isEqualTo(3);
    assertThat(lowerBounds.containsKey(2)).isFalse();
    assertThat(lowerBounds.containsKey(3)).isFalse();
    assertThat(lowerBounds.containsKey(4)).isFalse();
    ...
    assertThat((int) Conversions.fromByteBuffer(Types.IntegerType.get(), upperBounds.get(1)))
        .isEqualTo(3);
    assertThat(upperBounds.containsKey(2)).isFalse();
    assertThat(upperBounds.containsKey(3)).isFalse();
    assertThat(upperBounds.containsKey(4)).isFalse();
